...
//import microservice.starter.domain.EmailFormat
...
//  implicit val formats: Formats = DefaultFormats + new LocalDateTimeSerializer() + new EmailFormatSerializer()
//
...
//)
//
//class EmailFormatSerializer extends CustomSerializer[EmailFormat](format =>
//  ( {
//    case JString(s) => EmailFormat.withName(s)
//    case JNull => null
//  }, {
//    case s: EmailFormat => JString(s.toString)
//  })
//)
